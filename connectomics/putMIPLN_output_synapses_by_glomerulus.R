...
############ DETERMINE WHICH GLOMERULI A GIVEN putMIP LN *OUTPUT* SYNAPSE IS LOCATED  ##########################################
...
###create a new dataframe with all of the summed results from each glomerulus...
...
write.csv(OVERALLRESULTS, file = "outputs_usingSchlegeletalPNmeshes.csv")
...
remove(MIPLN14.OVERALLRESULTS)
  ...
  ###remove putMIP LN connector dataframes...
remove(mipln1.conns,mipln2.conns,mipln3.conns,mipln4.conns,mipln5.conns,mipln6.conns, mipln7.conns, mipln8.conns, mipln9.conns, mipln10.conns,mipln11.conns, mipln12.conns, mipln13.conns, mipln14.conns)
